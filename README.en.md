...
| ![Free](https://img.shields.io/badge/Free-green) | [Thread Rescuer](https://github.com/lovstudio/fix-deepseek-tool-call-error-skill) (`fix-deepseek-tool-call-error`) | Scan local Codex rollouts to list every No tool output found incident, explain why the thread wedged, and hand back a recovery and prevention plan. |
