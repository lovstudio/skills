...
| ![Paid](https://img.shields.io/badge/Paid-blueviolet) | [Universal WeChat Key](https://github.com/lovstudio/wdb-cli-skill) (`wdb-cli`) | Auto-discover WDB Pro managed keys and run precise local WeChat searches across chats, contacts, Moments, schemas, and exact records. |
| **Business** | | |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Lovinsp Setup](https://github.com/lovstudio/integrate-lovinsp-skill) (`integrate-lovinsp`) | Integrate Lovinsp in a frontend project — requires: `branding-consistency` |
...
| **Video Creation** | | |
| ![Paid](https://img.shields.io/badge/Paid-blueviolet) | [Video Studio](https://github.com/lovstudio/media-creator-skill) (`media-creator`) | Turn recordings and Screen Studio projects into reviewable video, then deliver approved horizontal and vertical videos, covers, and quality reports. |
