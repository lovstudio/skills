...
| ![Free](https://img.shields.io/badge/Free-green) | [Media Downloader](https://github.com/lovstudio/media-crawler-skill) (`media-crawler`) | Turn an authorized social-media link into a verified local media file, with a WeChat client capture fallback for publisher-restricted Channels videos. |
