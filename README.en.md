...
| ![Free](https://img.shields.io/badge/Free-green) | [`clean-mac`](https://github.com/lovstudio/macos-disk-optimizer-skill) | Clean up Mac storage with guarded planning, archive migration, exact rollback-item purging, and real-capacity verification. |
