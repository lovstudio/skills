...
|---|---|---|
| **General** | | |
| ![Free](https://img.shields.io/badge/Free-green) | [Requirements Compass](https://github.com/lovstudio/brainstorm-skill) (`brainstorm`) | Help clarify requirements through brainstorming — requires: `branding-consistency` |
...
| ![Paid](https://img.shields.io/badge/Paid-blueviolet) | [Mac Cleaner](https://github.com/lovstudio/macos-disk-optimizer-skill) (`clean-mac`) | Clean up Mac storage without touching protected app workspaces or build directories that installed plugins and extensions still load from, with guarded migration, rollback, and real-capacity verification. |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Dev Diary](https://github.com/lovstudio/daily-post-skill) (`daily-post`) | Write a daily project update from real changes — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Ebook Finder](https://github.com/lovstudio/find-ebook-skill) (`find-ebook`) | Find legally licensed ebook sources and access paths for a given book through due-diligence search. |
| ![Free](https://img.shields.io/badge/Free-green) | [Five-Unit Replies](https://github.com/lovstudio/five-skill) (`five`) | Use a five-unit concise reply mode — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Knowledge Organizer](https://github.com/lovstudio/kb-organize-skill) (`kb-organize`) | Organize a knowledge base and its references — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Video Inventory](https://github.com/lovstudio/list-videos-skill) (`list-videos`) | List every video file in a folder or across volumes in seconds with an incremental cache and optional ffprobe details. |
| ![Free](https://img.shields.io/badge/Free-green) | [Universal Video Grabber](https://github.com/lovstudio/media-crawler-skill) (`media-crawler`) | Turn an authorized social-media link into a verified local media file, with a WeChat client capture fallback for publisher-restricted Channels videos. |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Knowledge Capture](https://github.com/lovstudio/memory-add-skill) (`memory-add`) | Save a knowledge note with categories and tags — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Knowledge Finder](https://github.com/lovstudio/memory-search-skill) (`memory-search`) | Search a personal knowledge base — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Image Prompt Crafter](https://github.com/lovstudio/nano-banana-pro-skill) (`nano-banana-pro`) | Create a structured image prompt — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Content Keeper](https://github.com/lovstudio/output-skill) (`output`) | Save the current content to a file — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [WeChat Moments Copy](https://github.com/lovstudio/output-wechat-moment-skill) (`output-wechat-moment`) | Format and save a WeChat Moments post — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Session Sharing](https://github.com/lovstudio/share-session-skill) (`share-session`) | Turn an agent session into a free or Credits-unlocked LovStudio web page. — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Product Problem Solver](https://github.com/lovstudio/harness-issue-skill) (`harness-issue`) | Think through upcoming product requirements from the user's perspective when an issue or vague request comes in. — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Product OnePage](https://github.com/lovstudio/product-onepage-skill) (`product-onepage`) | Turn a product brief, URL, repository or notes into a one-page product overview. — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Knowledge Card Studio](https://github.com/lovstudio/gen-card-skill) (`gen-card`) | Lay out structured content and diagrams as copyable, downloadable knowledge cards in HTML and 2x PNG. — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Image Finishing](https://github.com/lovstudio/image-decorator-skill) (`image-decorator`) | Add a caption bar and brand logo to PNG, JPEG or WebP images with framed or frameless layouts. — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Spectacular Portraits](https://github.com/lovstudio/spectacular-ps-skill) (`spectacular-ps`) | Retouch travel or outdoor photos into striking environmental portraits that keep the person's features. — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [HTML to Slides](https://github.com/lovstudio/html2pptx-skill) (`html2pptx`) | Convert HTML into a high-fidelity PPTX deck with a real browser engine. — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Plane Assistant](https://github.com/lovstudio/plane-cli-skill) (`plane-cli`) | Read and write a Plane project-management instance from the command line: projects, work items, cycles and comments. |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Feishu Doc Sync](https://github.com/lovstudio/publish-feishu-doc-skill) (`publish-feishu-doc`) | Sync local Markdown faithfully into a Feishu wiki document and read back content, location and permissions. — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Table to Image](https://github.com/lovstudio/table2image-skill) (`table2image`) | Render Markdown tables into accessible PNG images, optionally with Mable layout presets. — requires: `branding-consistency` |
...
| **Content Creation** | | |
| ![Free](https://img.shields.io/badge/Free-green) | [Writing Pattern Scan (Legacy)](https://github.com/lovstudio/anti-wechat-ai-check-skill) (`anti-wechat-ai-check`) | Legacy entry that scans Chinese text for surface writing patterns; new work routes to lov-human-writing. — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Dev Journal](https://github.com/lovstudio/dev-blog-skill) (`dev-blog`) | Summarize the current development context and its visuals into a Chinese blog post and publish it to the website blog. — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [WeChat Channels Embed](https://github.com/lovstudio/lovpen-add-wechat-channel-comp-skill) (`lovpen-add-wechat-channel-comp`) | Normalize WeChat Channels DOM or Lovpen DSL into embeddable Markdown and native HTML components. — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [WeChat Typesetter](https://github.com/lovstudio/lovpen-cli-skill) (`lovpen-cli`) | Render Markdown into WeChat-ready inline HTML with the verified lovpen-cli, matching the Lovpen copy chain. — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Article Output (Legacy)](https://github.com/lovstudio/output-for-article-skill) (`output-for-article`) | Legacy entry for article file output; new work routes to the lov-article-creator package-output pipeline. — requires: `article-creator`, `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Article Repost (Legacy)](https://github.com/lovstudio/repost-wechat-article-skill) (`repost-wechat-article`) | Legacy entry for faithful WeChat article reposts; new work routes to the lov-article-creator repost pipeline. — requires: `article-creator` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Article Branding (Legacy)](https://github.com/lovstudio/wechat-article-branding-skill) (`wechat-article-branding`) | Legacy entry for WeChat article branding; new work routes to the lov-article-creator brand pipeline. — requires: `article-creator`, `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [WeChat Draft Operator (Legacy)](https://github.com/lovstudio/wechat-article-operator-skill) (`wechat-article-operator`) | Legacy entry for existing WeChat drafts; new work routes to lov-publish-wechat-article. |
...
| **Dev Tools** | | |
| ![Free](https://img.shields.io/badge/Free-green) | [Task Capture](https://github.com/lovstudio/add-task-skill) (`add-task`) | Add an item to the current task list — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Web Tool Studio](https://github.com/lovstudio/add-tool-skill) (`add-tool`) | Add an online tool to an existing website — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Agent Guide Keeper](https://github.com/lovstudio/agent-instructions-skill) (`agent-instructions`) | Review or improve project agent instructions — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Algorithm Theater](https://github.com/lovstudio/algo-viz-creator-skill) (`algo-viz-creator`) | Turn an algorithm or data-flow concept into a self-contained, step-by-step interactive HTML visualization. — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [WeChat Experience Alignment](https://github.com/lovstudio/align-wechat-uiux-skill) (`align-wechat-uiux`) | Diagnose and fix semantic and UI/UX gaps between a product and official WeChat messaging, chats, contacts and Moments. — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Gateway Studio](https://github.com/lovstudio/api-creator-skill) (`api-creator`) | Add an app's gateway endpoints to the uni-api FastAPI backend and a unified client layer in uni-app. |
| ![Free](https://img.shields.io/badge/Free-green) | [App Update Assistant](https://github.com/lovstudio/app-delta-updater-skill) (`app-delta-updater`) | Design, implement and verify auto-updates for Tauri and Electron apps, separating signed full packages from true deltas. |
...
| ![Free](https://img.shields.io/badge/Free-green) | [App Performance Doctor](https://github.com/lovstudio/app-optimizer-skill) (`app-optimizer`) | Fix jank, power drain, memory growth and resource leaks in interactive apps using real runtime evidence. |
| ![Free](https://img.shields.io/badge/Free-green) | [Performance Architect](https://github.com/lovstudio/app-professional-design-skill) (`app-professional-design`) | Diagnose and ship commercial-grade performance architecture for desktop, web and mobile apps. |
| ![Free](https://img.shields.io/badge/Free-green) | [App Release Pilot](https://github.com/lovstudio/app-release-skill) (`app-release`) | Run a verifiable multi-channel app release: versions, signed iOS/Android builds, GitHub, website, stores and live readback. — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Architecture Atlas](https://github.com/lovstudio/architecture-documentation-skill) (`architecture-documentation`) | Create architecture documentation from a codebase — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Feature Studio](https://github.com/lovstudio/atom-feature-dev-skill) (`atom-feature-dev`) | Implement one atomic feature as SDK, CLI, REST API, frontend, profile preset and Agent Skill, verified from one dashboard. — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [CSS Polish](https://github.com/lovstudio/better-css-skill) (`better-css`) | Refactor CSS and Tailwind styles — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [GitHub Repository Description Optimization](https://github.com/lovstudio/better-github-desc-skill) (`better-github-desc`) | Update a GitHub repository description from its README — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Project Organizer](https://github.com/lovstudio/better-project-structure-skill) (`better-project-structure`) | Improve a project directory structure — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [README Polish](https://github.com/lovstudio/better-readme-skill) (`better-readme`) | Create or improve a project README — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Next.js SEO Assistant](https://github.com/lovstudio/better-seo-skill) (`better-seo`) | Review and improve Next.js SEO — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Status Line Studio](https://github.com/lovstudio/better-statusline-skill) (`better-statusline`) | Update an agent status line with rollback — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Code Reviewer](https://github.com/lovstudio/code-review-skill) (`code-review`) | Review a code change for actionable defects — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Codeex Plugin Studio](https://github.com/lovstudio/codeex-creator-skill) (`codeex-creator`) | Create, validate and iterate local runtime plugins for Codeex, including hooks, native UI reuse and atomic install. |
| ![Free](https://img.shields.io/badge/Free-green) | [Codex Usage Ledger](https://github.com/lovstudio/codex-thread-usage-skill) (`codex-thread-usage`) | Account token usage for a whole Codex thread and its latest snapshot from a deeplink or thread UUID. |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Tech Selection Advisor](https://github.com/lovstudio/dev-research-skill) (`dev-research`) | Research a development plan and technology choices — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Production Readiness](https://github.com/lovstudio/dev-to-prod-skill) (`dev-to-prod`) | Converge a development project into a verified production build and local installation. |
| ![Free](https://img.shields.io/badge/Free-green) | [Lesson Distiller](https://github.com/lovstudio/distill-skill) (`distill`) | Distill a solved problem into reusable knowledge — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Lessons to Rules](https://github.com/lovstudio/distill-to-system-skill) (`distill-to-system`) | Persist a reusable lesson in agent instructions — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Plugin Advisor](https://github.com/lovstudio/dsh-search-or-create-plugin-skill) (`dsh-search-or-create-plugin`) | Search the DSH plugin gateway for the best fit for a goal, then use it or design a new plugin. |
| ![Free](https://img.shields.io/badge/Free-green) | [Plugin Radar](https://github.com/lovstudio/dsh-search-plugin-skill) (`dsh-search-plugin`) | Search the public dshfind plugin gateway and return ranked, evidence-tagged DSH plugins. |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Link Fixer](https://github.com/lovstudio/fix-broken-links-skill) (`fix-broken-links`) | Find and fix broken links in a project — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Log Detective](https://github.com/lovstudio/fix-by-add-log-skill) (`fix-by-add-log`) | Debug a problem with targeted logging — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Codex Provider Repair](https://github.com/lovstudio/fix-codex-provider-skill) (`fix-codex-provider`) | Fix Codex failing to open by aligning persisted thread providers with config.toml, with read-only evidence and backups. |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Codex × DeepSeek Thread First Aid](https://github.com/lovstudio/fix-deepseek-tool-call-error-skill) (`fix-deepseek-tool-call-error`) | Scan local Codex rollouts to list every No tool output found incident, explain why the thread wedged, and hand back a recovery and prevention plan. |
| ![Free](https://img.shields.io/badge/Free-green) | [Troubleshooter](https://github.com/lovstudio/fix-general-skill) (`fix-general`) | Diagnose and fix a software error — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Verified Fixes](https://github.com/lovstudio/fix-until-no-error-skill) (`fix-until-no-error`) | Fix errors until the specified checks pass — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Searchable Select](https://github.com/lovstudio/frontend-select-with-search-skill) (`frontend-select-with-search`) | Upgrade selects with more than five options into searchable, scrollable, keyboard-accessible components. |
| ![Free](https://img.shields.io/badge/Free-green) | [Logo Studio](https://github.com/lovstudio/gen-logo-skill) (`gen-logo`) | Create a logo and application icon — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Project Namer](https://github.com/lovstudio/gen-project-name-skill) (`gen-project-name`) | Generate a project name from its purpose — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Context Commit](https://github.com/lovstudio/git-commit-with-context-skill) (`git-commit-with-context`) | Create a Git commit for the current task changes — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Command Helper](https://github.com/lovstudio/help-cmd-skill) (`help-cmd`) | Create a command line for a task — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [I18n Inspector](https://github.com/lovstudio/i18n-check-i18n-skill) (`i18n-check-i18n`) | Review and fix frontend internationalization — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Document Visuals](https://github.com/lovstudio/illustrate-skill) (`illustrate`) | Illustrate a document with evidence and relevant images — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Supabase Auth Setup](https://github.com/lovstudio/init-auth-skill) (`init-auth`) | Add Supabase authentication to a React application — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Port Setup](https://github.com/lovstudio/init-port-skill) (`init-port`) | Configure a stable development port — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Design System Setup](https://github.com/lovstudio/install-design-skill) (`install-design`) | Install a project design system — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [shadcn/ui Setup](https://github.com/lovstudio/install-shadcn-ui-skill) (`install-shadcn-ui`) | Install and configure shadcn/ui for a project — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Tauri Icon Setup](https://github.com/lovstudio/install-tauri-logo-skill) (`install-tauri-logo`) | Install a logo in a Tauri application — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Website Logo Setup](https://github.com/lovstudio/install-web-logo-skill) (`install-web-logo`) | Install a web logo and favicon set — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [ZenMux Setup](https://github.com/lovstudio/install-zenmux-api-skill) (`install-zenmux-api`) | Integrate the ZenMux API through a secure backend — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Agent Chat UI](https://github.com/lovstudio/integrate-agent-uiux-skill) (`integrate-agent-uiux`) | Integrate agent conversations, tool activity, status, Markdown and composer into React or React Native apps. |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Multimodal API Setup](https://github.com/lovstudio/integrate-lovstudio-llm-skill) (`integrate-lovstudio-llm`) | Use the LovStudio.AI OpenAI-compatible API for chat, speech-to-text, translation, TTS and realtime audio. |
| ![Free](https://img.shields.io/badge/Free-green) | [Web Capture Export](https://github.com/lovstudio/integrate-modern-screenshot-skill) (`integrate-modern-screenshot`) | Add one-click PNG export of a page's main content with modern-screenshot, matching on-screen rendering at 2x. |
| ![Free](https://img.shields.io/badge/Free-green) | [Emoji Makeover](https://github.com/lovstudio/kill-emoji-skill) (`kill-emoji`) | Replace interface emoji with appropriate icons — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Website Legal Pages](https://github.com/lovstudio/legal-pages-skill) (`legal-pages`) | Draft website privacy and terms pages — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Workflow Studio](https://github.com/lovstudio/meta-command-skill) (`meta-command`) | Turn a repeated command workflow into a portable skill — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Tauri Icon Alignment](https://github.com/lovstudio/normalize-tauri-app-icon-skill) (`normalize-tauri-app-icon`) | Calibrate the visible frame, corner safe area and runtime embedding of a Tauri macOS Dock icon. |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Obsidian Dev Sync](https://github.com/lovstudio/obsidian-ensure-dev-sync-skill) (`obsidian-ensure-dev-sync`) | Fix an Obsidian plugin development sync chain — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Codex Session Reader](https://github.com/lovstudio/read-codex-session-skill) (`read-codex-session`) | Read turn summaries, status, tool activity and results of a local Codex task or thread. |
| ![Free](https://img.shields.io/badge/Free-green) | [API Refiner](https://github.com/lovstudio/refactor-api-skill) (`refactor-api`) | Refactor redundant backend APIs — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Module Refactorer](https://github.com/lovstudio/refactor-modular-skill) (`refactor-modular`) | Refactor a large file into cohesive modules — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Project Renamer](https://github.com/lovstudio/rename-project-skill) (`rename-project`) | Rename a project and preserve compatibility — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Repository Takeover](https://github.com/lovstudio/repo-takeover-skill) (`repo-takeover`) | Publish a cloned repository under your account — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Project Finder](https://github.com/lovstudio/search-project-skill) (`search-project`) | Locate a project or source folder on this machine in layers and return candidate paths with evidence. |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Version Keeper](https://github.com/lovstudio/version-management-skill) (`version-management`) | Manage package versions with Changesets — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [Version Review](https://github.com/lovstudio/version-management-manual-skill) (`version-management-manual`) | Create a changeset for manual review — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Voice to Subtitles](https://github.com/lovstudio/voice2srt-skill) (`voice2srt`) | Transcribe recordings, podcasts or videos into editable SRT, JSON and text with vocabulary boosting and cost preview. — requires: `branding-consistency` |
| **Meta** | | |
| ![Free](https://img.shields.io/badge/Free-green) | [Feedback Flywheel](https://github.com/lovstudio/feedback-loop-skill) (`feedback-loop`) | Turn satisfaction and complaints into tracked feedback that tunes your prompts and skills. |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Skill Naming Master](https://github.com/lovstudio/skill-namer-skill) (`skill-namer`) | Name, rename and review one Skill or a whole set, producing accurate, short and consistent Chinese and English names. — requires: `branding-consistency` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [Skill Lens](https://github.com/lovstudio/skill-visualizer-skill) (`skill-visualizer`) | Render a local Agent Skill as a scenario-first one-page trust review, runtime map and JSON model. — requires: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [YOLO Mode](https://github.com/lovstudio/yolo-mode-skill) (`yolo-mode`) | Prepare permissions within host rules, then complete a task autonomously from presets without asking questions. — requires: `branding-consistency` |
<!-- SKILLS:END -->
