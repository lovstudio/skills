...
| **内容创作** | | | |
| ![Free](https://img.shields.io/badge/Free-green) | [`article-creator`](https://github.com/lovstudio/article-creator-skill) | [公众号文章创作系统](https://github.com/lovstudio/article-creator-skill) | 先明确读者变化与创作战略，再从材料、旧稿或来源文章生成完整公众号文章包。 — 依赖: `branding-consistency`, `writing-style` |
...
| ![Free](https://img.shields.io/badge/Free-green) | [`illustrate`](https://github.com/lovstudio/illustrate-skill) | [文档智能配图](https://github.com/lovstudio/illustrate-skill) | 按证据价值和视觉预算为长文规划、生成与组装必要插图，并完成可溯源验收。 — 依赖: `branding-consistency` |
| ![Free](https://img.shields.io/badge/Free-green) | [`lovpen-add-wechat-channel-comp`](https://github.com/lovstudio/lovpen-add-wechat-channel-comp-skill) | [Lovpen 视频号组件](https://github.com/lovstudio/lovpen-add-wechat-channel-comp-skill) | 把一段视频号组件规范化后准确插入 Lovpen Markdown 或原生 HTML，不改动其他正文。 — 依赖: `branding-consistency` |
