...
| ![Free](https://img.shields.io/badge/Free-green) | [`clean-mac`](https://github.com/lovstudio/macos-disk-optimizer-skill) | [清理 Mac](https://github.com/lovstudio/macos-disk-optimizer-skill) | 按目标容量整理 Mac 磁盘，支持归档迁移、精确回收回滚项，并以真实可用空间完成验收。 |
