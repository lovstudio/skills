...
| ![Free](https://img.shields.io/badge/Free-green) | [`clean-mac`](https://github.com/lovstudio/macos-disk-optimizer-skill) | [清理 Mac](https://github.com/lovstudio/macos-disk-optimizer-skill) | 按目标容量整理 Mac 磁盘，保护 Screen Studio 等应用工作区，并以可回滚操作和真实可用空间完成验收。 |
