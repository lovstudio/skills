...
- 本地改动：统一展示名为「文档插画师」，保持调用 ID 与能力契约。
- 本地改动：统一展示名称为「文档插图生成」，保留原有调用 ID 与能力边界。
...
- add README and complete metadata
- document install, options, and generation dependencies
