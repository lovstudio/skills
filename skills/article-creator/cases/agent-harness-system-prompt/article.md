...
![文章首图](cover/article-opening-vertical.jpg)
...
![Codex：一位有主体感的同事](assets/agent-harness-cards/codex.jpg)
...
![Claude Code：一名严谨的工程师](assets/agent-harness-cards/claude-code.jpg)
...
![Pi：请叫我没有感情的杀手](assets/agent-harness-cards/pi.jpg)
...
![DSH：您自个儿爱咋滴咋滴](assets/agent-harness-cards/dsh.jpg)
