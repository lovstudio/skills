...
Structure for user preferences in `.lov-skills/lov-any2deck/EXTEND.md`.
...
Then use with: `/lov-any2deck content.md --style style-name`
...
1. `.lov-skills/lov-any2deck/EXTEND.md` (project)
2. `$HOME/.lov-skills/lov-any2deck/EXTEND.md` (user)
