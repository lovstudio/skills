...
description: >
  把单人照片用 gpt-image-2 重绘成身份保真的 Riso 头像，并检查五官、手指、饰品与圆形裁切；适用于“做成 Riso 人像”“生成孔版印刷头像”和 “create a Riso portrait”。
license: MIT
...
1. 解析 Skill 根目录，读取 `skill.yaml`、`references/riso-art-direction.md`、
   `references/quality-gate.md` 与 `references/skill-composition.md`。
