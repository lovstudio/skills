...
| --- | --- | --- |
| `lov-search-chat` | 从本地 Ataru 记忆里召回过去的会话上下文，返回带稳定标识的命中与原文片段 | downstream atom |
